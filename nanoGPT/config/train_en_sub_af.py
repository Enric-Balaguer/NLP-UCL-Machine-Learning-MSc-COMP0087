# Train a model on english subset with active forgetting

out_dir = 'out-en-sub-af' # directory to save the results in the end
...
# Active forgetting
active_forgetting = True # should we train with active forgetting or not
